    ...
    <Card className="w-full max-w-xl mx-auto text-center shadow-lg border-none bg-transparent">
      <CardHeader>
        <CardDescription className="text-lg text-gray-700">
          O Método MounjaroMental ajuda a gerenciar sua relação com a comida “corrigindo” a falha de comunicação entre seu cérebro e seu estômago.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        />
        <CardDescription className="text-lg text-gray-700">
          Vamos começar aprendendo mais sobre você para avaliar se o MounjaroMental também pode te ajudar.
        </CardDescription>
      </CardContent>
