    ...
    <Card className="w-full max-w-xl mx-auto text-center shadow-lg border-none bg-transparent">
      <CardHeader>
        <CardDescription className="text-lg text-gray-700">
          A maioria das soluções para emagrecimento não aborda a verdadeira causa do excesso de peso, como a falha de comunicação entre cérebro e estômago. O MounjaroMental é diferente.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center justify-center gap-2">
            ...
            <span className="font-semibold text-gray-700">Seu progresso com o MounjaroMental</span>
        </div>
        <CardDescription className="text-md text-gray-700 pt-4">
          De acordo com estudos clínicos, a mudança de mentalidade resolve essa falha de comunicação.
        </CardDescription>
      </CardContent>
