...
const writtenTestimonials = [
    { name: 'Carla S.', comment: 'Perdi 8kg em um mês sem sentir que estava de dieta. A mudança de mentalidade me ajudou a controlar a ansiedade e a comer com mais consciência. Incrível!' },
    { name: 'Marcos P.', comment: 'Finalmente entendi meus gatilhos emocionais com a comida. O MounjaroMental foi um divisor de águas. Recomendo demais!' },
...
const faqItems = [
    { question: "A mudança de mentalidade é segura?", answer: "Sim, é um processo completamente seguro e natural. Você permanece no controle o tempo todo, em um estado de relaxamento focado, semelhante à meditação." },
...
export function Step30_FinalOffer({ data }: Props) {
    ...
    return (
        <div className="space-y-8 font-body overflow-x-hidden">
            ...
            <Card className="shadow-lg border-none bg-transparent text-center">
                <CardContent className="p-0 space-y-4">
                    <div className="grid grid-cols-2 gap-4 items-start">
                        <div>
                            <h3 className="font-bold text-lg mb-2">Antes do MOUNJAROMENTAL</h3>
                            <Image src="https://i.imgur.com/2vjQaB0.jpeg" alt="Antes do MounjaroMental" width={300} height={300} className="mx-auto rounded-lg" />
                        ...
                        <div>
                            <h3 className="font-bold text-lg mb-2">Depois do MOUNJAROMENTAL</h3>
                            <Image src="https://i.imgur.com/TYvuBmJ.jpeg" alt="Depois do MounjaroMental" width={300} height={300} className="mx-auto rounded-lg" />
                            <ul className="text-sm text-left mt-2 space-y-1 list-disc list-inside">
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-center font-headline">ALGUMAS TRANSFORMAÇÕES COM O MOUNJAROMENTAL</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <Card>
                ...
                <div className="flex justify-center p-6">
                    <a href={checkoutUrl} className="block w-full max-w-md">
                        <Button size="lg" className="w-full text-lg h-12 bg-green-600 hover:bg-green-700 text-white animate-pulse-strong">QUERO O MOUNJAROMENTAL</Button>
                    </a>
                </div>
            </Card>
            ...
            <Card>
                <CardContent className="p-6 text-center space-y-4">
                    ...
                    <p>Sua satisfação é nossa prioridade. Se por qualquer motivo você não estiver 100% satisfeito com o Método MounjaroMental nos primeiros 7 dias, basta nos enviar um e-mail. Devolveremos todo o seu dinheiro, sem perguntas.</p>
                </CardContent>
            </Card>
            <Card>
                 <CardHeader>
