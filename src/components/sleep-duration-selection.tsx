...
type SleepDurationSelectionProps = {
...
const options = [
  ...
  '7–8 horas',
  '5–6 horas',
  'Tenho dificuldade em dormir. Algumas noites, durmo menos de 5 horas.',
];

export function SleepDurationSelection({
  onContinue,
}: SleepDurationSelectionProps) {
