...
type HabitChangeSelectionProps = {
...
const options = [
  ...
  'Sim, consigo',
  'Consigo alguns finais de semanas outros não',
];

export function HabitChangeSelection({ onContinue }: HabitChangeSelectionProps) {
    ...
    <Card className="w-full max-w-2xl mx-auto shadow-lg">
      <CardHeader>
        <CardTitle className="font-headline text-3xl text-center">
          Você consegue mudar seu hábito alimentar para um novo plano de refeições incluindo fins de semana?
        </CardTitle>
      </CardHeader>
      <CardContent>
        <RadioGroup
