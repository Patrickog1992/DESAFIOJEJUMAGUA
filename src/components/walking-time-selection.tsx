...
type WalkingTimeSelectionProps = {
...
export function WalkingTimeSelection({ onContinue }: WalkingTimeSelectionProps) {
    ...
    <Card className="w-full max-w-2xl mx-auto shadow-lg">
      <CardHeader>
        <CardTitle className="font-headline text-3xl text-center">
          Quanto tempo você passa caminhando no seu dia a dia?
        </CardTitle>
      </CardHeader>
      <CardContent>
        <RadioGroup
