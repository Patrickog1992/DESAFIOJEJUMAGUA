        ...
        <div className="space-y-8 font-body overflow-x-hidden">
            ...
            <Card>
                ...
                <CardContent className="flex justify-center p-6">
                   <div style={{position: 'relative', width: '100%', maxWidth: '500px', height: '0', paddingTop: '15%', paddingBottom: '0', boxShadow: '0 2px 8px 0 rgba(63,69,81,0.16)', marginTop: '1.6em', marginBottom: '0.9em', overflow: 'hidden', borderRadius: '8px', willChange: 'transform'}}>
                        <iframe loading="lazy" style={{position: 'absolute', width: '100%', height: '100%', top: '0', left: '0', border: 'none', padding: '0', margin: '0'}} src="https://www.canva.com/design/DAG1N7k1i8Y/dWFu8xnOeXV9ArZoLfFyMA/watch?embed" allowFullScreen={true} allow="fullscreen"></iframe>
                   </div>
                </CardContent>
            </Card>
